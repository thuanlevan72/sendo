  ...
  const getData = async () => {
    try {
      const response = await axios.get(
        `https://api-sendo.vercel.app/giohang?userId=${currentUser.id}`
      );
    ...
    <>
      {cartItem == undefined || cartItem.length == 0 ? (
        <div className="mx-auto w-96 mt-20">
          ...
          <h3 className="text-base font-normal text-center mt-4 text-gray-300">
            Ai đó ơi, mua sắm để nhận khuyến mãi từ Sendo ngay!
          </h3>
          <div className=" flex justify-center">
            <Linkroute to={"/"}>
              <button className=" px-7 bg-red-500 rounded text-white font-bold text-sm py-3">
                Mua sắm ngay
              </button>
            </Linkroute>
          </div>
        ...
        <div className="mx-0 md:mx-1 lg:mx-2 xl:mx-5 px-3 md:px-[16px] pt-[22px]">
          <div className="title flex items-center mb-4">
            <h1 className="text-[20px] font-bold mr-4 mb-0">
              Giỏ hàng của bạn ({counter})
            </h1>
                    ...
                    <div className="bg-white rounded-lg p-[10px] md:p-[20px] mb-4 w-full text-[14px]">
                      <div className="shop-name flex justify-between items-center">
                        <div className="flex items-center">
                          ...
                          <h1 className="m-0 text-[14px] font-bold">
                            {item.brand}
                          </h1>
                        </div>
                        ...
                        <div className="hidden md:flex w-[100%] items-center justify-between">
                          <div className="lg:flex">
                            ...
                            <div className="w-[50%] m-0">
                              <p className="m-0 bg-blue-100 rounded-[20px] text-[12px] text-blue-800 font-bold px-2 w-[120px]">
                                Mua trước trả sau
                              </p>
                              <Linkroute
                                to={`/productdetail/${item.idProduct}`}>
                                <h1 className="text-[14px] px-1 my-1">
                                  {item.title}
                                </h1>
                              </Linkroute>
                            </div>
                          ...
                          <div className="flex items-center md:mr-3">
                            <button
                              className="px-2 bg-gray-200 rounded h-8 md:text-xl text-gray-400 mx-0.5 border hover:bg-gray-100"
                          ...
                          <div className="flex md:px-3">
                            <Tooltip title={heart}>
                              <AiOutlineHeart
                                ...
                                style={{
                                  color: selectedColorIndices.includes(index)
                                    ? "red"
                                    : "initial",
                                }}
                          ...
                          <div className="flex">
                            ...
                            <div className="flex px-3">
                              ...
                              <Modal
                                ...
                                cancelButtonProps={{
                                  className:
                                    "border-none font-bold shadow-none",
                                }}
                                okType="none">
                                <p>Xóa sản phẩm khỏi giỏ hàng?</p>
                              </Modal>
                      ...
                      {selectedIndex == index && (
                        <div className="md:hidden px-5 pb-4 text-[14px]">
                          ...
                          <Linkroute to={"/checkOut"}>
                            <button
                              className="bg-red-500 w-full text-white font-bold text-[16px] rounded h-12"
                              onClick={handleBuy}>
                              Mua ngay
                            </button>
                          </Linkroute>
