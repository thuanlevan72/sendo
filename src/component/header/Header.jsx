...
const Header = () => {
  ...
  const items = [
    {
      key: "1",
      label: <Linkroute to={"/inforUser"}>Thông tin tài khoản</Linkroute>,
    },
    {
      key: "2",
      label: (
    ...
    <>
      <div className=" bg-red-700  text-white px-3 md:px-10">
        <div className="sub-header-content mx-0 font-bold md:mx-1 lg:mx-2 xl:mx-5">
          <span className="download py-3 pr-2 md:pr-5 cursor-pointer">
            Tải ứng dụng
          </span>
          <span className="customer-care py-3 pr-2 md:pr-5 cursor-pointer">
            Chăm sóc khách hàng
          </span>
          <span className="order-check py-3 pr-2 md:pr-5 cursor-pointer">
            Kiểm tra đơn hàng
          </span>
        </div>
      </div>
          ...
          <div className="absolute right-0 flex items-center">
            ...
            {isLogged && currentUser ? (
                ...
                <Button className="bg-white px-1 ml-5 rounded-[1.25rem]">
                  <p className=" flex items-center text-[12px] m-0 font-bold mr-[4px]">
                    <img
                      ...
                      src="https://media3.scdn.vn/images/apps/icon_user_default.png"
                      alt=""
                    />
              ...
              <div className="signin px-5 py-2 bg-white rounded-md">
                <Linkroute to={"/signin"}>
                  <p className="text-sm m-0 text-black font-bold">Đăng nhập</p>
                </Linkroute>
              </div>
            )}
          </div>
